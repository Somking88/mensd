...
/*function showResults(obj) {
  ...
  // alert(formSum);
  var resVariants = [
    {min: 0, max: 9, result: "Незначительно выраженные симптомы "},
    {min: 10, max: 18, result: "Средне выраженные симптомы"},
    {min: 19, max: 31, result: "Тяжелые симптомы"}
  ];
  ...
  if (formQuestions==formAnswers) {
    ...
    testResult="Результат: "+testResult;

  } else {
    testResult="Необходимо ответить на все вопросы теста. Отвечено "+formAnswers+" из "+formQuestions+"";
  }
